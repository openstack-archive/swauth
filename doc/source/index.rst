...
3.  It also uses Swift's `authorize callback <https://docs.openstack.org/swift/latest/development_auth.html>`_ and `acl callback <https://docs.openstack.org/swift/latest/misc.html#swift.common.middleware.acl>`_ features to authorize Swift requests.
